...
JointIntegrator::JointIntegrator(const int num_joints_in, const double dt_in) {
  my_utils::pretty_constructor(3, "WBC Joint Integrator");
...
JointIntegrator::JointIntegrator(const int num_joints_in,
                                 ...
                                 const double dt_in) {
  my_utils::pretty_constructor(3, "IHWBC Joint Integrator");
  n_joints_ = num_joints_in;
  vel_ = Eigen::VectorXd::Zero(n_joints_);
  pos_ = Eigen::VectorXd::Zero(n_joints_);
  setDt(dt_in);
...
void JointIntegrator::printIntegrationParams() {
  ...
  my_utils::pretty_print(vel_min_, std::cout, "velocity_min");
  my_utils::pretty_print(vel_max_, std::cout, "velocity_max");
  my_utils::pretty_print(pos_min_, std::cout, "position_min");
  my_utils::pretty_print(pos_max_, std::cout, "position_max");
  my_utils::pretty_print(pos_max_error_, std::cout, "position max error");

  my_utils::pretty_print(pos_, std::cout, "position current");
  my_utils::pretty_print(vel_, std::cout, "velocity current");
}
