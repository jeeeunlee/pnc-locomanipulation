...
// force variable to be minimized: Fc (resultant contact force)

class WBRMC_ExtraData{
    public:
        // Output
...
class WBRMC: public WBC{
    public:
        WBRMC(const std::vector<bool> & act_list, const Eigen::MatrixXd* Jci = NULL);
        virtual ~WBRMC(){}
