#include <my_wbc/WBDC/WBDC.hpp>
#include <my_utils/IO/IOUtilities.hpp>
#include <Eigen/LU>
#include <Eigen/SVD>

WBDC::WBDC(const std::vector<bool> & act_list): WBC(act_list){
    my_utils::pretty_constructor(3, "WBDC");
...
bool WBDC::_CheckNullSpace(const Eigen::MatrixXd & Npre){
    ...
    //my_utils::pretty_print(svd.singularValues(), std::cout, "svd singular value");
...
void WBDC::makeTorque(const std::vector<Task*> & task_list,
    ...
    //my_utils::pretty_print(Sf_, std::cout, "Sf");
    //my_utils::pretty_print(qddot_pre, std::cout, "qddot_pre");
    //my_utils::pretty_print(JcN, std::cout, "JcN");
    //my_utils::pretty_print(Nci_, std::cout, "Nci");
    //vx eq_check = dyn_CE * data_->opt_result_;
    //my_utils::pretty_print(dyn_ce0, std::cout, "dyn ce0");
    //my_utils::pretty_print(eq_check, std::cout, "eq_check");

    //my_utils::pretty_print(Jt, std::cout, "Jt");
    //my_utils::pretty_print(JtDotQdot, std::cout, "Jtdotqdot");
...
void WBDC::_SetInEqualityConstraint(){
    ...
    // my_utils::pretty_print(dyn_CI, std::cout, "WBDC: CI");
    // my_utils::pretty_print(dyn_ci0, std::cout, "WBDC: ci0");
}
...
void WBDC::_ContactBuilding(const std::vector<ContactSpec*> & contact_list){
    ...
    // my_utils::pretty_print(Jc_, std::cout, "WBDC: Jc");
    // my_utils::pretty_print(JcDotQdot_, std::cout, "WBDC: JcDot Qdot");
    // my_utils::pretty_print(Uf_, std::cout, "WBDC: Uf");
}
...
void WBDC::_GetSolution(const Eigen::VectorXd & qddot, Eigen::VectorXd & cmd){
    ...
    //my_utils::pretty_print(UNci, std::cout, "UNci");
    //my_utils::pretty_print(UNci_trc, std::cout, "UNci+trc");
    //my_utils::pretty_print(UNciBar_trc, std::cout, "UNciBar_trc");
    //my_utils::pretty_print(tot_tau_trc, std::cout, "tot tau trc");
    //_WeightedInverse(UNci, Ainv_, UNciBar);
    //cmd = UNciBar.transpose() * tot_tau;
    // my_utils::pretty_print(result, std::cout, "opt result");
    //my_utils::pretty_print(tot_tau, std::cout, "tot tau result");
    //my_utils::pretty_print(cmd, std::cout, "final command");
}
