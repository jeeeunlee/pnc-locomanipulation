...
void MinJerk_OneDimension::printParameters(){
    ...
    //my_utils::pretty_print(init_cond, std::cout, "init_cond");
    //my_utils::pretty_print(end_cond, std::cout,  "end_cond");
    //my_utils::pretty_print(C_mat, std::cout, "Coeff_Matrix");
    //my_utils::pretty_print(C_mat_inv, std::cout, "C_mat_inv");

    //my_utils::pretty_print(a_coeffs, std::cout, "Coeff_Vector");
    //my_utils::pretty_print(bound_cond, std::cout, "Boundary Conditions");
}
