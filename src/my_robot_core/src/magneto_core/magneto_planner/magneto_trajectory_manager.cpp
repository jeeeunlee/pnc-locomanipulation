...
#include <my_robot_core/magneto_core/magneto_planner/magneto_trajectory_manager.hpp>

MagnetoTrajectoryManager::MagnetoTrajectoryManager(MagnetoWbmcControlArchitecture* _ctrl_arch) {
