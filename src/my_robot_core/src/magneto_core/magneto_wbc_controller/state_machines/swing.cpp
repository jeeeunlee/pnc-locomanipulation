...
void Swing::firstVisit() {
  ...
  ctrl_arch_->ws_container_->add_task_list(
        ctrl_arch_->ws_container_->com_task_);
  ctrl_arch_->ws_container_->add_task_list(
        ctrl_arch_->ws_container_->base_ori_task_);
  ctrl_arch_->ws_container_->add_task_list(
        ctrl_arch_->ws_container_->get_foot_pos_task(moving_foot_idx_));
  ctrl_arch_->ws_container_->add_task_list(
        ctrl_arch_->ws_container_->get_foot_ori_task(moving_foot_idx_));
  ctrl_arch_->ws_container_->add_task_list(
  ...
  ctrl_arch_->ws_container_->set_magnetism(moving_foot_idx_);    
  ctrl_arch_->ws_container_->set_residual_magnetic_force(moving_foot_idx_);
  ctrl_arch_->ws_container_->set_contact_magnetic_force(moving_foot_idx_);
  ctrl_arch_->ws_container_->w_res_ = 1.0;

  // ---------------------------------------
  //      CONTACT LIST
  // --------------------------------------- 
  ctrl_arch_->ws_container_->set_contact_list(moving_foot_idx_);
...
void Swing::_ResidualMagnetismUpdate() {
  ...
  ctrl_arch_->ws_container_->set_residual_magnetic_force(moving_foot_idx_, contact_distance);
}
